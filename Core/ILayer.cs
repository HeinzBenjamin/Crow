...
namespace Crow.Core
{
    ...
    public interface ILayer : ISerializable
    {
        ...
        /// chose the learning rate function: 0: LinearFunction, 1: HyperbolicFunction, 2: ExponentialFunction
        /// </param>
        void SetLearningRate(double initialLearningRate, double finalLearningRate, int LearningRateFunction);
        ...
        bool ParallelComputation { get; set; }
